...
const propTypes = {
  newContactsRelationZZ: PropTypes.object,
  loading: PropTypes.object,
  form: PropTypes.object,
  children: PropTypes.object,
}
function NewContactsRelation({
  newContactsRelationZZ,
  loading,
  form: { validateFieldsAndScroll, resetFields },
}) {
  const { modalVisible, tableData, searchKeys, pageConfig, initValue } = newContactsRelationZZ
...
export default connect(({ newContactsRelationZZ, loading }) => ({ newContactsRelationZZ, loading }))(
