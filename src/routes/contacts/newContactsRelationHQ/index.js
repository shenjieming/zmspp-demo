...
const propTypes = {
  newContactsRelationHQ: PropTypes.object,
  loading: PropTypes.object,
  form: PropTypes.object,
  children: PropTypes.object,
}
function NewContactsRelation({
  newContactsRelationHQ,
  loading,
  form: { validateFieldsAndScroll, resetFields },
}) {
  const { modalVisible, tableData, searchKeys, pageConfig, initValue } = newContactsRelationHQ
...
export default connect(({ newContactsRelationHQ, loading }) => ({ newContactsRelationHQ, loading }))(
