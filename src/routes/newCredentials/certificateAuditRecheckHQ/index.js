...
const propTypes = {
  recheckCertificateAuditHQ: PropTypes.object,
  loading: PropTypes.object,
}
const namespace = 'recheckCertificateAuditHQ'
const CertificatePush = ({ recheckCertificateAuditHQ, loading }) => {
  const {
    tabType,
    reviewSearchData,
    refusedSearchData,
...
export default connect(({ recheckCertificateAuditHQ, loading }) => ({ recheckCertificateAuditHQ, loading }))(
  CertificatePush,
)
