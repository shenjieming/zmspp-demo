...
const propTypes = {
  newCertificateAuditHQ: PropTypes.object,
  loading: PropTypes.object,
}
const namespace = 'newCertificateAuditHQ'
const CertificatePush = ({ newCertificateAuditHQ, loading }) => {
  const {
    tabType,
    reviewSearchData,
    refusedSearchData,
...
export default connect(({ newCertificateAuditHQ, loading }) => ({ newCertificateAuditHQ, loading }))(
  CertificatePush,
)
