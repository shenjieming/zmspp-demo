...
const propTypes = {
  recheckCertificateAudit: PropTypes.object,
  loading: PropTypes.object,
}
const namespace = 'recheckCertificateAudit'
const CertificatePush = ({ recheckCertificateAudit, loading }) => {
  const {
    tabType,
    reviewSearchData,
    refusedSearchData,
...
export default connect(({ recheckCertificateAudit, loading }) => ({ recheckCertificateAudit, loading }))(
  CertificatePush,
)
