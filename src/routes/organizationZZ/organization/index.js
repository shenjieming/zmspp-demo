...
const namespace = 'organizationZZ'
function IndexPage({ organizationZZ, dispatch, loading, app: { constants: { addressList } } }) {
...
IndexPage.propTypes = {
  ...
  organizationZZ: PropTypes.object,
  dispatch: PropTypes.func,
}

export default connect(({ organizationZZ, app, loading }) => ({ organizationZZ, app, loading }))(
  IndexPage,
)
